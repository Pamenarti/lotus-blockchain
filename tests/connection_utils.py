...
async def disconnect_all_and_reconnect(server: lotusServer, reconnect_to: lotusServer) -> bool:
...
async def add_dummy_connection(server: lotusServer, dummy_port: int) -> Tuple[asyncio.Queue, bytes32]:
...
async def connect_and_get_peer(server_1: lotusServer, server_2: lotusServer) -> WSlotusConnection:
    """
