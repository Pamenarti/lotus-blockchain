...
required to run a [Timelord](https://github.com/Lotus-Network/lotus-blockchain/wiki/Timelords).
...
[install-timelord.sh](https://github.com/Lotus-Network/lotus-blockchain/blob/main/install-timelord.sh)
