...
mv lotus-darwin-x64 ../build_scripts/dist/
cd ../build_scripts || exit

DMG_NAME="lotus-$lotus_INSTALLER_VERSION.dmg"
echo "Create $DMG_NAME"
mkdir final_installer
electron-installer-dmg dist/lotus-darwin-x64/lotus.app lotus-$lotus_INSTALLER_VERSION \
