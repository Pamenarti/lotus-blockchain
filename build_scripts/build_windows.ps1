...
Write-Output "pip install lotus-blockchain"
pip install --no-index --find-links=.\win_build\ lotus-blockchain
...
Write-Output "   ---"
Copy-Item "dist\daemon" -Destination "..\lotus-blockchain-gui\" -Recurse
