...
class WebSocketServer:
    ...
    async def start_service(self, request: Dict[str, Any]):
        ...
        if not validate_service(service_command):
            error = f"{service_command} - unknown service"
