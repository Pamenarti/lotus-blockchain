...
from lotusbip158 import PyBIP158
    ...
    async def declare_proof_of_space(
        ...
        async with self.full_node.timelord_lock:
            ...
            if prev_b is None:
                ...
                self.log.warning(f"Farmer Puzzle Hash: {farmer_ph}")
                ...
                self.log.warning(f"Farmer: Pool Target: {pool_target}")
                self.log.warning(f"Farmer: Request: {request}")
