...
# the output will be printed to your lotus root path, e.g. ~/.lotus-blockchain/mainnet/profile/
# to analyze the profile, run:

#   python lotus/utils/profiler.py ~/.lotus-blockchain/mainnet/profile | less -r
...
#   python lotus/utils/profiler.py ~/.lotus-blockchain/mainnet/profile 10 20
