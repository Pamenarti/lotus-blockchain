...
rate_limits_other = {
    ProtocolMessageTypes.handshake: RLSettings(25, 10 * 1024, 5 * 10 * 1024),
    ProtocolMessageTypes.harvester_handshake: RLSettings(25, 1024 * 1024),
    ProtocolMessageTypes.new_signage_point_harvester: RLSettings(500, 1024),
    ProtocolMessageTypes.new_proof_of_space: RLSettings(500, 2048),
    ProtocolMessageTypes.request_signatures: RLSettings(500, 2048),
    ProtocolMessageTypes.respond_signatures: RLSettings(600, 2048),
    ProtocolMessageTypes.new_signage_point: RLSettings(1000, 2048),
    ProtocolMessageTypes.declare_proof_of_space: RLSettings(500, 10 * 1024),
    ProtocolMessageTypes.request_signed_values: RLSettings(500, 512),
    ProtocolMessageTypes.farming_info: RLSettings(500, 1024),
    ProtocolMessageTypes.signed_values: RLSettings(500, 1024),
    ProtocolMessageTypes.new_peak_timelord: RLSettings(500, 20 * 1024),
    ProtocolMessageTypes.new_unfinished_block_timelord: RLSettings(500, 10 * 1024),
    ProtocolMessageTypes.new_signage_point_vdf: RLSettings(500, 100 * 1024),
    ProtocolMessageTypes.new_infusion_point_vdf: RLSettings(500, 100 * 1024),
    ProtocolMessageTypes.new_end_of_sub_slot_vdf: RLSettings(500, 100 * 1024),
    ProtocolMessageTypes.request_compact_proof_of_time: RLSettings(1000, 10 * 1024),
    ProtocolMessageTypes.respond_compact_proof_of_time: RLSettings(1000, 100 * 1024),
    ProtocolMessageTypes.new_peak: RLSettings(1000, 512),
    ...
    ProtocolMessageTypes.request_block: RLSettings(500, 100),
    ProtocolMessageTypes.reject_block: RLSettings(500, 100),
    ProtocolMessageTypes.request_blocks: RLSettings(1000, 100),
    ProtocolMessageTypes.respond_blocks: RLSettings(1000, 50 * 1024 * 1024, 5 * 50 * 1024 * 1024),
    ProtocolMessageTypes.reject_blocks: RLSettings(1000, 100),
    ProtocolMessageTypes.respond_block: RLSettings(1000, 2 * 1024 * 1024, 10 * 2 * 1024 * 1024),
    ...
    ProtocolMessageTypes.request_puzzle_solution: RLSettings(500, 100),
    ProtocolMessageTypes.respond_puzzle_solution: RLSettings(500, 1024 * 1024),
    ProtocolMessageTypes.reject_puzzle_solution: RLSettings(500, 100),
    ProtocolMessageTypes.new_peak_wallet: RLSettings(1000, 300),
    ...
    ProtocolMessageTypes.reject_header_request: RLSettings(1000, 100),
    ...
    ProtocolMessageTypes.request_peers_introducer: RLSettings(1000, 100),
    ProtocolMessageTypes.respond_peers_introducer: RLSettings(1000, 1024 * 1024),
    ProtocolMessageTypes.farm_new_block: RLSettings(1000, 200),
}
