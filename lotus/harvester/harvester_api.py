...
from lotus.plotting.plot_tools import PlotInfo, parse_plot_info
            ...
            try:
                ...
                if quality_strings is not None:
                    ...
                    for index, quality_str in enumerate(quality_strings):
                        ...
                        self.harvester.log.debug(f"Proof check required_iters:{required_iters} sp_interval_iters:{sp_interval_iters}")
